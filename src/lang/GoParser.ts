// Generated from src/lang/GoParser.g4 by ANTLR 4.9.0-SNAPSHOT
  ...
  public sourceFile(): SourceFileContext {
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        while (
          (_la & ~0x1f) === 0 &&
          ((1 << _la) & ((1 << GoParser.FUNC) | (1 << GoParser.CONST) | (1 << GoParser.TYPE) | (1 << GoParser.VAR))) !==
            0
        ) {
          {
            {
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        while (
          ...
          (((_la - 57) & ~0x1f) === 0 &&
            ((1 << (_la - 57)) &
              ((1 << (GoParser.UNDERLYING - 57)) | (1 << (GoParser.STAR - 57)) | (1 << (GoParser.RECEIVE - 57)))) !==
              0)
        ) {
          {
            {
    ...
    try {
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          ...
          (((_la - 42) & ~0x1f) === 0 &&
            ((1 << (_la - 42)) &
              ((1 << (GoParser.ELLIPSIS - 42)) | (1 << (GoParser.STAR - 42)) | (1 << (GoParser.RECEIVE - 42)))) !==
              0)
        ) {
          {
            this.state = 764;
